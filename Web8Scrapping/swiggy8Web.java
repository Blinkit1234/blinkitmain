        ...
        try {
            ...
            for (int i = 0; i < uRL.size(); i++) {
               ...
               /*     //location sets 
                    ...
                    if(equalPin != locationSet) {
                    
                    Thread.sleep(2000);
                    
                    try {
                    WebElement location = driver.findElement(By.xpath("/html/body/div/div/div/header/div/nav/div[1]/div/div[1]/button/div/div/p"));
					Thread.sleep(4000);
					location.click();
                    }
                    catch(Exception e) {
                    	WebElement location = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div/button[1]"));
    					Thread.sleep(4000);
    					location.click();
                    }
					...
					for (int j = 0; j < 2; j++) {
						try {
							driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/input"))
									.sendKeys(Keys.ENTER);
							
							driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/input")).clear();
							...
							driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/input"))
							.sendKeys(Keys.ENTER);
					
					driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/input")).clear();
					...
					driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/div/div/div[2]/div[1]/div")).click();
					Thread.sleep(4000);
					
					driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div/div/div[2]/div/button[2]")).click();
...
//                   NewAvailability1 = String.valueOf(result);
            ...
            FileOutputStream outFile = new FileOutputStream(".\\Output\\Swiggy outputData.xlsx");
