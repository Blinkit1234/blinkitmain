	        ...
	        try {
	            ...
	            for (int i = 0; i < uRL.size(); i++) {
	                ...
	                try {
	                        ...
	                        Thread.sleep(9000); 	
	                         ...
	                         for(int k=0;k < 100;k++) {
	                          	...
	                          	//WebElement location = driver.findElement(By.xpath("/html/body/div[1]/div/header/div/div[1]/button"));
	                          	 WebElement location = driver.findElement(By.xpath("//div[@class='relative mx-auto bg-skin-base']//div[@class='flex items-center gap-x-6 py-5 px-16']//div[@class='relative flex h-[2.75rem] flex-1 flex-col justify-center lg:flex-initial']//button"));
	           					location.click();
	           					break;
	                          }
	                          	catch(Exception r) {
	           				...
	           				//	Thread.sleep(1000);909
	           					...
	           					for (int j = 0; j < 200; j++) {
	           						...
	           						//	700091
	           							...
	           							driver.findElement(
	           									By.xpath("/html/body/div[3]/div/div/div/div/div/div/div[2]/div/div[2]/div[1]/input"))
	           									.sendKeys(Keys.ENTER);
	           							}
	           							Thread.sleep(200);
	           							try {
             							...
             							driver.findElement(
	           									By.xpath("/html/body/div[3]/div/div/div/div/div/div/div[2]/div/div[2]/div[1]/input")).clear();
	           							...
	           							driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div/div/div/div[2]/div/div[2]/div[2]/div[1]/div")).click();
	           								...
	           								driver.findElement(By.xpath("/html/body/div[3]/div/div/div/div/div/div/div[2]/div/div[2]/div[2]/div[1]/div")).click();
	           						...
	           						/*	driver.findElement(
	           							...
	           							driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/div/div/div/div/div[2]/div/div[2]/div/div[2]/div/button[2]")).click();
	           								...
	           								driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/div/div/div/div/div[2]/div/div[2]/div/div[2]/div/button[2]")).click();
	           							}
	           							Thread.sleep(2000);
	                    ...
	                    WebElement nameElement = driver.findElement(By.xpath("//div[@class='flex-1 sm:flex-initial']//h1"));
	                   ...
	                   try {
						...
						try {
						    String xpathForZepto = "//div[@class='flex flex-col px-4 sm:sticky sm:shrink-DEFAULT sm:grow-[5] sm:basis-0 sm:self-start sm:pl-10']//div[@class='mt-2 mb-1 flex items-start']//div[@class='ml-4']//div[1]";
						    //String xpathForZepto1 = "//div[@class='flex items-center justify-center']//span[@class='!tracking-wider']";
...
//	                   int result = 1;
//	                   try {
//                       WebElement available=driver.findElement(By.xpath("//div[@class='flex flex-col px-4 sm:sticky sm:shrink-DEFAULT sm:grow-[5] sm:basis-0 sm:self-start sm:pl-10']//div[@class='mt-2 mb-1 flex items-start']//div[@class='ml-4']//div[1]"));
