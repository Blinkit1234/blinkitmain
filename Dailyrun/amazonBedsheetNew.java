...
public class amazonBedsheetNew {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\amazon Bedsheet input.xlsx";
           ...
           /*         if(mrpValue == spValue) {
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Amazon_Bedsheet_OutputData_" + timestamp + ".xlsx";
