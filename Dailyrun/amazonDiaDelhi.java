...
public class amazonDiaDelhi {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\amazonDiaDel.xlsx";
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                /*   try {
                       WebElement offer = driver.findElement(By.xpath("//*[@id=\"corePrice_desktop\"]/div/table/tbody/tr[2]/td[2]/span[1]/span[2]"));
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Amazon_Diapers Delhi_OutputData_" + timestamp + ".xlsx";
