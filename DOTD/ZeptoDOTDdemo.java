        ...
        try {
            ...
            for (int i = 0; i < uRL.size(); i++) {
                ...
                try {
                   ...
                   // offer
                   try {
                       WebElement offer = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[4]/div[1]/div"));
            ...
            FileOutputStream outFile = new FileOutputStream(".\\Output\\Zepto s2outputData.xlsx");
